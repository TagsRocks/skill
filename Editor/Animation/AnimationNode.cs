...
namespace Skill.Editor.Animation
{
    ...
    public abstract class AnimationNode : IXElement
    {
        ...
        public abstract AnimationNode Clone();

        public virtual void CopyFrom(AnimationNode other)
        {
            this.X = other.X;
            this.Y = other.Y;
            this.Id = other.Id;
    ...
    public abstract class AnimationNodeProperties
    {
        [Browsable(false)]
        public AnimationNodeViewModel ViewModel { get; private set; }

        public AnimationNodeProperties(AnimationNodeViewModel vm)
        {
            ViewModel = vm;
        }
    ...
    public class AnimationNodeViewModel : DragableContent
    {
        ...
        public AnimationNodeProperties Properties { get; protected set; }

        public AnimationNode Model { get; private set; }
        ...
        #region Constructor
        public AnimationNodeViewModel() // for designer
        {

        }
        public AnimationNodeViewModel(AnimationNode model)
        {
            this.Model = model;
        }
