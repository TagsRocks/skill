...
{
    public class DictionaryDataTranslateWindow : UnityEditor.EditorWindow
    {
        ...
        #region EditorWindow
        private static DictionaryDataTranslateWindow _Instance;
        public static DictionaryDataTranslateWindow Instance
        {
            get
            {
                if (_Instance == null)
                {
                    _Instance = ScriptableObject.CreateInstance<DictionaryDataTranslateWindow>();
                }
                return _Instance;
            }
        }
        ...
        public DictionaryDataTranslateWindow()
        {
        ...
        private Skill.Editor.UI.ObjectField<DictionaryData> _SourceField;
        private Skill.Editor.UI.ObjectField<DictionaryData> _TranslateField;
        ...
        private void CreateBox1()
        {
            ...
            _SourceField = new Skill.Editor.UI.ObjectField<DictionaryData>() { Row = 0, Column = 0, Margin = new Thickness(2), VerticalAlignment = VerticalAlignment.Bottom };
            _SourceField.Label.text = "Source";
            grid.Controls.Add(_SourceField);

            _TranslateField = new Skill.Editor.UI.ObjectField<DictionaryData>() { Row = 1, Column = 0, Margin = new Thickness(2), VerticalAlignment = VerticalAlignment.Top };
        ...
        public DictionaryData Source { get { return _Source; } set { _SourceField.Object = value; } }
        public DictionaryData Translate { get { return _Translate; } set { _TranslateField.Object = value; } }


        [SerializeField]
        private DictionaryData _Source;
        [SerializeField]
        private DictionaryData _Translate;
        ...
        private void CopyKeys()
        {
            ...
            if (_Translate != null && _Source != null)
            {
                List<TextKey> list = new List<TextKey>();
        ...
        private TextKey GetKey(DictionaryData dictionary, string key)
        {
