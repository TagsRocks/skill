...
namespace Skill.Editor.UI
{
    ...
    public class Popup : Control
    {
        ...
        protected override void Paint()
        {
            ...
            if (Style != null)
            {
                SelectedIndex = EditorGUI.IntPopup(PaintArea, Label, _SelectedIndex, Options.Contents, Options.Values, Style);
            }
            else
            {
                SelectedIndex = EditorGUI.IntPopup(PaintArea, Label, _SelectedIndex, Options.Contents, Options.Values);
            }
        }        
    }
}
