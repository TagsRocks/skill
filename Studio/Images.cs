...
namespace Skill.Studio
{
    ...
    {        
        ...
        public static string ChangeState { get { return Path.Combine(ImageDirectory, "ChangeState.png"); } }
        public static string ChangeState_D { get { return Path.Combine(ImageDirectory, "ChangeState_D.png"); } }        
