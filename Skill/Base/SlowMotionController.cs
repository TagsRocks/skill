...
namespace Skill
{
    ...
    /// </summary>
    [AddComponentMenu("Skill/SlowMotionController")]
    public class SlowMotionController : DynamicBehaviour
    {
        ...
        private Skill.SlowMotionInfo _Info;
        private Skill.TimeWatch _MotionTW;
        private Skill.TimeWatch _FreezeTW;        
        ...
        protected override void Update()
        {
            ...
            if (_MotionTW.Enabled)
            {
                if (_MotionTW.IsOver)
                {
                    if (Sounds.PitchController.Instance != null)
                        Sounds.PitchController.Instance.Pitch = 1.0f;
                    Time.timeScale = 1;
                    enabled = false;
                    _MotionTW.End();
                    _Info = null;
                ...
                else
                {
                    ...
                    if (Sounds.PitchController.Instance != null)
                        Sounds.PitchController.Instance.Pitch = _Info.Pitch;
